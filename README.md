...
If there is a foreseeable collision if following the last trajectory, the new trajectory is generated from the 
5th position of the last trajectory.

By keeping 2 seconds safety distance, collisions could be avoided.
